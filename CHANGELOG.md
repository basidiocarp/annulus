...
- **Release lockfile repair**: restored the valid `dirs-sys` and `heck` lock entries after the `0.5.0` release bump accidentally rewrote unrelated dependencies to nonexistent versions.
